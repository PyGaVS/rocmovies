...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<Movie> movies = new ArrayList<Movie>(List.of(
            new Movie("Inception", styles.get(0), 2010,
                "https://upload.wikimedia.org/wikipedia/en/2/2e/Inception_%282010%29_theatrical_poster.jpg"),
            new Movie("Gladiator", styles.get(3), 2000,
            ...
            new Movie("Titanic", styles.get(1), 1997,
            ...
            new Movie("CONFRONTATION", styles.get(3), 1999,
                "https://i.pinimg.com/736x/86/77/85/867785590fe46fddbdc3a31026f1e3f0.jpg"),
            new Movie("Die Hard", styles.get(3), 1988,
